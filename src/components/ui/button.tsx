  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-normal focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-background hover:bg-secondary shadow-sm hover:shadow-md",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-sm hover:shadow-md",
        ghost: "hover:bg-secondary hover:text-secondary-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        quiz: "bg-card text-card-foreground border border-input hover:border-primary hover:bg-primary-lighter shadow-sm hover:shadow-md transition-all duration-normal",
        success: "bg-success text-success-foreground hover:bg-success-light shadow-sm hover:shadow-md",
        generate: "bg-primary text-primary-foreground hover:bg-primary-light shadow-md hover:shadow-lg hover:scale-[1.02] transition-all duration-normal font-semibold",
      },
      size: {
        ...
        icon: "h-10 w-10",
        quiz: "h-14 px-6 py-4 text-base rounded-xl",
      },
    },
    defaultVariants: {
      variant: "default",
